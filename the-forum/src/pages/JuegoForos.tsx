    ...
    <div className="animate-in fade-in duration-500">
      ...
      <div className="p-8 max-w-6xl mx-auto space-y-8 -mt-4 relative z-10">
        ...
        <div className="flex flex-col md:flex-row gap-4 bg-white p-4 rounded-lg shadow-sm border border-gray-100">
          ...
          <select 
            className="flex h-10 w-full md:w-64 rounded-md border border-input bg-white px-3 py-2 text-sm ring-offset-background focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring"
